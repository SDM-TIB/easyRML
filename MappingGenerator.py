...
def readConfig(config):
    ...
    "@prefix ql: <http://semweb.mmlab.be/ns/ql#> .", "@prefix schema: <http://schema.org/> .",
    "@prefix xsd: <http://www.w3.org/2001/XMLSchema#> .", "@prefix fnml: <http://semweb.mmlab.be/ns/fnml#> .", 
    ...
    "ql": "http://semweb.mmlab.be/ns/ql#", "schema":"http://schema.org/", "xsd":"http://www.w3.org/2001/XMLSchema#",
    "fnml":"http://semweb.mmlab.be/ns/fnml#", "fno":"https://w3id.org/function/ontology#"}
    ...
    ##read predicate objects
        for i in range(1,int(config['TM'+str(t)]['number_of_POM'])+1):
            ...
            print (prefix_abrv + "----" + predicate_value)
